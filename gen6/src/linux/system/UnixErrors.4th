...
1 constant MinValue               ( Minimum value )
134 constant MaxValue             ( Maximum Value + 1 )
...
( Translates Unix error code ec to error message string e$. )
: >errmsg ( ec -- e$ )
  dup MinValue MaxValue within unless  1 "Unknown Unix error code: %d"|abort  then
  ERRTAB$ swap 1− 0 do  count + count +  loop  count + ;
